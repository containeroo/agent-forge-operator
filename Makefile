...
# ghcr.io/containeroo/agent-forge-operator-bundle:$VERSION and ghcr.io/containeroo/agent-forge-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/containeroo/agent-forge-operator
...
deploy: manifests kustomize ## Deploy controller to the K8s cluster specified in ~/.kube/config.
	...
	$(KUSTOMIZE) build "$$tmp_dir/config/default" | $(KUBECTL) apply -f -
...
api-docs: gen-crd-api-reference-docs
	$(GEN_CRD_API_REFERENCE_DOCS) -api-dir=./api/v1alpha1 -config=./hack/api-docs/config.json -template-dir=./hack/api-docs/template -out-file=./api-ref.html
