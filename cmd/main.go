...
import (
	...
	"github.com/containeroo/agent-forge-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(agentforgev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "agent-forge-operator.containeroo.ch",
