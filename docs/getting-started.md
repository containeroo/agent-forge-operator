...
```sh
kubectl delete -k github.com/containeroo/agent-forge-operator//config/default?ref=v0.0.16
kubectl delete -f https://github.com/containeroo/agent-forge-operator/releases/download/v0.0.16/crds.yaml
```
