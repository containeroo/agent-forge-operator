...
```sh
kubectl apply -f https://github.com/containeroo/agent-forge-operator/releases/download/v0.0.6/crds.yaml
```

Deploy the controller:

```sh
kubectl apply -k github.com/containeroo/agent-forge-operator//config/default?ref=v0.0.6
```
...
```sh
kubectl delete -k github.com/containeroo/agent-forge-operator//config/default?ref=v0.0.6
kubectl delete -f https://github.com/containeroo/agent-forge-operator/releases/download/v0.0.6/crds.yaml
```
